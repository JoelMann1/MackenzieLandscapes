...
(function(){
  ...
  const updateParallax = () => {
    ...
    parallaxImages.forEach((img, index) => {
      ...
      // Spread images across the full scroll with controlled overlap
      const segmentSize = 1 / (totalImages - 1); // Divide scroll evenly
      const overlapFactor = 1.8; // Each image visible for 1.8x its segment (creates 2-3 simultaneous)
      const imageStartProgress = index * segmentSize * 0.85; // Start slightly earlier
